# -*- coding: utf-8 -*-
"""
Created on Mon Jan 16 12:28:54 2023
...
if __name__ == "__main__": 
    ...
    master.geometry("575x415") 
    equation = StringVar() 
    formule_field = Entry(master, textvariable=equation) 
    formule_field.grid(columnspan=10,  pady= 40 , padx = 40 , ipadx = 150 , ipady = 40)
...
egaliter = Button(master, text='=', command=equalclick, height=2, width=10) 
egaliter.grid(row=6, column='0') 
